...
public class L2022212022_17_Test {
    ...
    @Test
    public void test1(){
        List<String> result_A=Solution.findRepeatedDnaSequences("AAAAAAAAAA");
        List<String> result_A2=Solution.findRepeatedDnaSequences("AACCCTTTG");
        boolean result_a=CollectionUtils.isEmpty(result_A);
        boolean result_a2=CollectionUtils.isEmpty(result_A2);
        System.out.println(result_a);
        System.out.println(result_a2);
    }
    ...
    public void test2(){
        ...
        test_B.add("AAAACCCGTT");
        test_B.add("AAACCCGTTT");
    ...
    @Test
    public void test3(){
        List<String> result_C=Solution.findRepeatedDnaSequences("AAAAAAAAACGTTTTTTT");
